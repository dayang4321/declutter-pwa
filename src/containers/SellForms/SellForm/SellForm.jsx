    ...
    if (e.target.files[0]) {
      ...
      getBlobDuration(blobURL).then(function (duration) {
        console.log(duration + " seconds");
          ...
          if (duration > 21) {
            toast.dismiss()
          toast.dark("Video must be 20 seconds or less!", {
            position: "top-right",
            autoClose: 5000,
          ...
          return;
        } else type === "defect" ? setDefectVideoFile([{ file: file, data: blobURL }]) : setVideoFile([{ file: file, data: blobURL }]);
      });
    }
    return;
  };
